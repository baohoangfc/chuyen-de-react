            ...
            <div>
                ...
                <div className="shop_inner_inf">
                    ...
                    <div className="col-md-7 contact_grid_right">
                        ...
                        <textarea name="Message"   required defaultValue={"Message..."} />
                    ...
                    <div className="col-md-5 contact-left">
                        ...
                        <div className="visit">
                        <div className="col-md-2 col-sm-2 col-xs-2 contact-icon">
                            <span className="fa fa-fax" aria-hidden="true" />
                        </div>
                        <div className="col-md-10 col-sm-10 col-xs-10 contact-text">
                            <h4>Fax</h4>
                            <p>+1804426349</p>
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100949.24429313939!2d-122.44206553967531!3d37.75102885910819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan+Francisco%2C+CA%2C+USA!5e0!3m2!1sen!2sin!4v1472190196783" className="map" style={{border: 0}} allowFullScreen />
                </div>
        </div>
